...
AI_LIMIT_ORDER_THRESHOLD = 0.60

# 🛡️ 3. DYNAMIC RISK (SESSION BASED)
SESSION_RISK = {
    "ASIAN": 0.5,             
    "LONDON": 1.0,            
    "NY_LONDON_OVERLAP": 1.0, 
    "NEW_YORK": 1.0,          
    "ROLLOVER": 0.0           
}
...
# ⏱️ 8. TIME-BASED VOLATILITY SETTINGS
KILLZONE_TRACK_START = 1
KILLZONE_TRACK_END = 7
KILLZONE_EXEC_START = 8
KILLZONE_EXEC_END = 11
FILTER_LONDON_FAKEOUTS = True
